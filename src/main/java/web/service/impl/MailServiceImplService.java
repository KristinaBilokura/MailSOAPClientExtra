 ...
 * 
 */
@WebServiceClient(name = "MailServiceImplService", targetNamespace = "http://impl.service.web/", wsdlLocation = "http://localhost:8080/MailService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MAILSERVICEIMPLSERVICE_QNAME = new QName("http://impl.service.web/", "MailServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/MailService?wsdl");
    ...
    public MailService getMailServiceImplPort() {
        return super.getPort(new QName("http://impl.service.web/", "MailServiceImplPort"), MailService.class);
    }
    ...
    public MailService getMailServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.service.web/", "MailServiceImplPort"), MailService.class, features);
    }
